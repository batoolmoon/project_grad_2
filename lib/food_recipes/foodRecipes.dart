...
class _foodState extends State<food> {
  ...
  getApiData() async {
    final url =
        'https://api.edamam.com/search?q=chicken&app_id=a49f0c78&app_key=05eaa965fec47bb03412c36d06e3f8e7&from=0&to=100&calories=591-722&health=alcohol-free';
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          openLink(
                              "https://www.delish.com/cooking/recipe-ideas/a39800628/air-fryer-butternut-squash-recipe/");
                        },
                        child: Container(
                          // color:Colors.red ,
...
class _SearchPageState extends State<SearchPage> {
  ...
  getApiData(search) async {
    final url =
        'https://api.edamam.com/search?q=$search&app_id=a49f0c78&app_key=05eaa965fec47bb03412c36d06e3f8e7&from=0&to=100&calories=591-722&health=alcohol-free';
    var response = await http.get(Uri.parse(url));
    Map json = jsonDecode(response.body);
    json['hits'].forEach((e) {
      Model model = Model(
